...
typedef struct __mavlink_hil_state_quaternion_t
{
 ...
 float y; ///< Ground Y
 float z; ///< Ground Z
 float xacc; ///< X acceleration (mg)
 float yacc; ///< Y acceleration (mg)
 float zacc; ///< Z acceleration (mg)
...
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN 88
#define MAVLINK_MSG_ID_115_LEN 88

#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC 83
#define MAVLINK_MSG_ID_115_CRC 83
...
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
	...
	{  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_state_quaternion_t, time_usec) }, \
         ...
         { "vx", NULL, MAVLINK_TYPE_FLOAT, 0, 48, offsetof(mavlink_hil_state_quaternion_t, vx) }, \
         { "vy", NULL, MAVLINK_TYPE_FLOAT, 0, 52, offsetof(mavlink_hil_state_quaternion_t, vy) }, \
         { "vz", NULL, MAVLINK_TYPE_FLOAT, 0, 56, offsetof(mavlink_hil_state_quaternion_t, vz) }, \
         { "x", NULL, MAVLINK_TYPE_FLOAT, 0, 60, offsetof(mavlink_hil_state_quaternion_t, x) }, \
         { "y", NULL, MAVLINK_TYPE_FLOAT, 0, 64, offsetof(mavlink_hil_state_quaternion_t, y) }, \
         { "z", NULL, MAVLINK_TYPE_FLOAT, 0, 68, offsetof(mavlink_hil_state_quaternion_t, z) }, \
         { "xacc", NULL, MAVLINK_TYPE_FLOAT, 0, 72, offsetof(mavlink_hil_state_quaternion_t, xacc) }, \
         { "yacc", NULL, MAVLINK_TYPE_FLOAT, 0, 76, offsetof(mavlink_hil_state_quaternion_t, yacc) }, \
         { "zacc", NULL, MAVLINK_TYPE_FLOAT, 0, 80, offsetof(mavlink_hil_state_quaternion_t, zacc) }, \
         { "ind_airspeed", NULL, MAVLINK_TYPE_UINT16_T, 0, 84, offsetof(mavlink_hil_state_quaternion_t, ind_airspeed) }, \
         { "true_airspeed", NULL, MAVLINK_TYPE_UINT16_T, 0, 86, offsetof(mavlink_hil_state_quaternion_t, true_airspeed) }, \
         } \
}
...
static inline uint16_t mavlink_msg_hil_state_quaternion_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint64_t time_usec, const float *attitude_quaternion, float rollspeed, float pitchspeed, float yawspeed, int32_t lat, int32_t lon, int32_t alt, float vx, float vy, float vz, float x, float y, float z, uint16_t ind_airspeed, uint16_t true_airspeed, float xacc, float yacc, float zacc)
{
	...
	_mav_put_float(buf, 60, x);
	_mav_put_float(buf, 64, y);
	_mav_put_float(buf, 68, z);
	_mav_put_float(buf, 72, xacc);
	_mav_put_float(buf, 76, yacc);
	_mav_put_float(buf, 80, zacc);
	_mav_put_uint16_t(buf, 84, ind_airspeed);
	_mav_put_uint16_t(buf, 86, true_airspeed);
...
{
	return mavlink_msg_hil_state_quaternion_pack(system_id, component_id, msg, hil_state_quaternion->time_usec, hil_state_quaternion->attitude_quaternion, hil_state_quaternion->rollspeed, hil_state_quaternion->pitchspeed, hil_state_quaternion->yawspeed, hil_state_quaternion->lat, hil_state_quaternion->lon, hil_state_quaternion->alt, hil_state_quaternion->vx, hil_state_quaternion->vy, hil_state_quaternion->vz, hil_state_quaternion->x, hil_state_quaternion->y, hil_state_quaternion->z, hil_state_quaternion->ind_airspeed, hil_state_quaternion->true_airspeed, hil_state_quaternion->xacc, hil_state_quaternion->yacc, hil_state_quaternion->zacc);
}
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_vx(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_vy(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_vz(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  56);
}

/**
 * @brief Get field x from hil_state_quaternion message
 *
 * @return Ground X
 */
static inline float mavlink_msg_hil_state_quaternion_get_x(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  60);
}

/**
 * @brief Get field y from hil_state_quaternion message
 *
 * @return Ground Y
 */
static inline float mavlink_msg_hil_state_quaternion_get_y(const mavlink_message_t* msg)
{
	return _MAV_RETURN_float(msg,  64);
}

/**
 * @brief Get field z from hil_state_quaternion message
 *
 * @return Ground Z
 */
static inline float mavlink_msg_hil_state_quaternion_get_z(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_xacc(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_yacc(const mavlink_message_t* msg)
{
 ...
 */
static inline float mavlink_msg_hil_state_quaternion_get_zacc(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_hil_state_quaternion_decode(const mavlink_message_t* msg, mavlink_hil_state_quaternion_t* hil_state_quaternion)
{
	...
	hil_state_quaternion->x = mavlink_msg_hil_state_quaternion_get_x(msg);
	hil_state_quaternion->y = mavlink_msg_hil_state_quaternion_get_y(msg);
	hil_state_quaternion->z = mavlink_msg_hil_state_quaternion_get_z(msg);
